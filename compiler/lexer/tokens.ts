...
export namespace Token {
	...
	export const MultiplicativeOperator = $CATEGORY('MultiplicativeOperator', Operator);
	...
	export const BoolLiteral = $TOKEN('BoolLiteral', /true|false/, { categories: Literal });
	...
	export const Multiply = $TOKEN('Multiply', '*', { categories: MultiplicativeOperator });
	export const Exponent = $TOKEN('Exponent', '^', { categories: ExponentialOperator });
	export const Divide = $TOKEN('Divide', '/', { categories: MultiplicativeOperator });
	export const Modulus = $TOKEN('Modulus', '%', { categories: MultiplicativeOperator });
	export const Bang = $TOKEN('Bang', '!', { categories: UnaryOperator });
	export const LogicalAnd = $TOKEN('LogicalAnd', '&&', { categories: LogicalOperator });
	export const LogicalOr = $TOKEN('LogicalOr', '||', { categories: LogicalOperator });
	...
	export const NotEqual = $TOKEN('NotEqual', '!=', { categories: EqualityOperator });
	...
	export const ReturnKw = $TOKEN('ReturnKw', 'return', { longer_alt: Identifier });
	...
	export const ElseIfKw = $TOKEN('ElseIfKw', 'elseif', { longer_alt: Identifier });
}
